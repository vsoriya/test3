...
def blackjack_game():
    ...
    while True:
        ...
        while user_score < 21:
            another_card = input("Type 'y' to get another card, 'n' to stop: ").lower()
            if another_card == 'y':
